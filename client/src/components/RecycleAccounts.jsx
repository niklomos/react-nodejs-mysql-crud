...
const Accounts = () => {
  ...
  const fetchUsers = useCallback(() => {
    ...
    axios
      .get(
        `http://localhost:3001/account//?limit=${accountsPerPage}&offset=${offset}&acc_status=0&search=${encodeURIComponent(
          searchTerm
        )}`
      )
      .then((response) => {
    ...
    <div className="container pt-3">
      <div className="card ">
        <div className="card-header ">
          <h2 className="text-center  text-light ">Recycle Accounts</h2>
        <div className="row">
